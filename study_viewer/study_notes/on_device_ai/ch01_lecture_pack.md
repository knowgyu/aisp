# Chapter 1 Lecture Pack — Pruning for CNN

이 파일은 강의 진행용 화면이다. 슬라이드 이미지는 PDF에서 추출했고, 코드는 notebook 셀 번호 기준으로 연결한다.

## 핵심 슬라이드

| 주제 | 슬라이드 | 파일 |
|---|---:|---|
| 전체 목차 | 3 | `assets/ch01_cnn_pruning_slides/slide_03.png` |
| Dataset / Model / Eval 준비 | 4-11 | `slide_04.png` ~ `slide_11.png` |
| Granularity / Pattern | 12 | `slide_12.png` |
| Fine-grained 실습 | 14-15 | `slide_14.png`, `slide_15.png` |
| Importance / Reconstruction 비교 | 16 | `slide_16.png` |
| Sensitivity analysis | 18 | `slide_18.png` |
| Global magnitude pruning | 23-24 | `slide_23.png`, `slide_24.png` |
| One-shot / Iterative pruning | 25-28 | `slide_25.png` ~ `slide_28.png` |

## 오늘 진행 순서

1. 왜 pruning이 필요한가
2. CNN/VGG/CIFAR-10 baseline 확인
3. Granularity: fine / vector / kernel / channel
4. Ratio: sensitivity / uniform / global
5. Schedule: one-shot / iterative
6. Chapter 1 시험형 문제풀이
